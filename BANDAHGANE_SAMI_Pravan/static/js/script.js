...
function update_Bars(data_JSON) {
    ...
    new Chart(document.getElementById("bar-chart"), {
        type: 'horizontalBar',  // Using horizontalBar type for side-by-side bars
        data: {
            labels: labels,
            datasets: [
                {
        ...
        options: {
            ...
            scales: {
                x: {
                    beginAtZero: true,  // Make sure the bars start from 0 on the x-axis
                },
                y: {
                    beginAtZero: true,  // Make sure labels start from 0 if needed
                }
            }
        }
    });
...
function update_BarChart(data_JSON5) {
    ...
    new Chart(document.getElementById("bar2-chart"), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Nombre détudiantes par année '
            },
            legend: {
                position: 'top'
            }
...
function update_BarChart6(data_JSON6) {
    ...
    new Chart(document.getElementById("bar3-chart"), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Nombre détudiants par année'
            },
            legend: {
                position: 'top'
            }
...
function update_BarChart8(data_JSON8) {
    ...
    new Chart(document.getElementById("bar-chart-8"), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Nombre détudiants par spécialité'
            },
            legend: {
                position: 'top'
            }
...
function update_LineChart9(data_JSON9) {
    ...
    new Chart(document.getElementById("line-chart-9"), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Tot de succes et échec par spécialité'
            },
            legend: {
                position: 'top'
            }
...
function update_PieChart10(data_JSON10) {
    ...
    new Chart(document.getElementById("pie-chart-avg"), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Moyenne des moyennes par spécialité'
            },
            legend: {
                position: 'top'
            }
